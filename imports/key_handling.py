...
def get_device_auth_2():
	request_headers = {
		...
		"Authorization": "basic " + os.getenv("DEVICE_AUTH")
	}
	request_data = {
		"grant_type": "device_auth",
		"account_id": os.getenv("DA_ACCOUNT_ID"),
		"device_id": os.getenv("DA_DEVICE_ID"),
		"secret": os.getenv("DA_SECRET")
	}
	r = requests.post(url, headers=request_headers, data=request_data)
	r = r.json()
	try:
		if r["access_token"]:
